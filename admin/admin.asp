...
menu(0,11)="<a href=http://www.pinluo.com/user/Services_show.asp?b=PL_0003&bg=000099&key=PinLuo.Com_DGWVUCNNMRJZVFCDMQ2L381EIMBNZT2FQGMOMDFUPND1AMF65DELWC5RQ7N7GZX1JHI5NXV7FVFMBACOSYAAV5HJTI2UZ8P34A9B&l=help target=main>程序使用帮助</a>"
...
menu(5,0)="采集管理"
menu(5,1)="<a href=../caiji/index.asp target=main>音乐采集列表</a>"
menu(5,2)="<a href=../caiji/index.asp target=main>添加采集站点</a>"
menu(5,3)="<a target=main href=../caiji/index.asp>关键字过滤</a>"
menu(5,4)="<a target=main href=../caiji/index.asp>百度歌词采集</a>"
menu(5,5)="<a target=main href=../caiji/index.asp>TOM歌词采集</a>"
menu(5,6)="<a target=main href=../caiji/index.asp>上次音乐采集结束ID</a>"
menu(5,7)="<a target=main href=../caiji/index.asp>上百度歌词采集结束ID</a>"
menu(5,8)="<a target=main href=../caiji/index.asp>TOM歌词采集结束ID</a>"
menu(5,9)="<a target=main href=../caiji/index.asp><font color=red>采集程序说明</font></a>"
...
<tr><td height=20>技术论坛：<a target="_blank" href="http://bbs.pinluo.com/">品络技术论坛</a></td></tr>
